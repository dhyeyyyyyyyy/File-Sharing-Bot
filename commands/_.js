...
User.setProperty("msg", message, "string")
}
if (request.photo[0]) {
...
var filid = request.photo[0].file_id
var rnu = generateString(15)
Bot.setProperty(rnu , filid ,"string")
var shareLink =
  "https://t.me/" + bot.name + "?start=Pic"+rnu
var shareButton = [
...
var shnk =
  "https://t.me/" + bot.name + "?start=Pic"+rnu+"cap"+t.value()
Api.sendMessage({
  text:
    "*Press The Button Or Click To Copy The Link Below To Share Your Photo!*\n\n" +
    shnk +
    "\n\nPress The [Button](https://t.me/"+ bot.name +"?start=Pic"+rnu+"cap"+t.value()+") To Open The Link",
  parse_mode: "Markdown",
...
Api.sendMessage({
  text:
    "*Press The Button Or Click To Copy The Link Below To Share Your Photo!*\n\n" +
    shareLink +
    "\n\nPress The [Button](https://t.me/"+ bot.name +"?start=Pic"+rnu+") To Open The Link",
  parse_mode: "Markdown",
  reply_markup: { inline_keyboard: shareButton }
})
}
